...
export class UpdateUserTable1742160278063 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user" DROP COLUMN "date_of_birthday"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ADD "date_of_birthday" character varying`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user" ADD "date_of_birthday" date NOT NULL`,
    );
    await queryRunner.query(
